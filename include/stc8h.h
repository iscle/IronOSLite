...
#define CLKSEL      (*(__xdata volatile unsigned char *)0xfe00)
#define	CKSEL		(*(__xdata volatile unsigned char *)0xfe00)	/* 主时钟源选择    */
#define	CLKDIV		(*(__xdata volatile unsigned char *)0xfe01)	/* 主时钟分频      */
#define	IRC24MCR	(*(__xdata volatile unsigned char *)0xfe02)	/* IRC 24MHZ控制   */
#define	XOSCCR		(*(__xdata volatile unsigned char *)0xfe03)	/* XOSC控制        */
#define	IRC32KCR	(*(__xdata volatile unsigned char *)0xfe04)	/* IRC 32KHZ控制   */
#define MCLKOCR   (*(__xdata volatile unsigned char *)0xfe05)
#define IRCDB     (*(__xdata volatile unsigned char *)0xfe06)
#define X32KCR    (*(__xdata volatile unsigned char *)0xfe08)
...
#define	P0PU		(*(__xdata volatile unsigned char *)0xfe10)	/* P0 4.1K Pull Up Enable  */
#define	P1PU		(*(__xdata volatile unsigned char *)0xfe11)	/* P1 4.1K Pull Up Enable  */
#define	P2PU		(*(__xdata volatile unsigned char *)0xfe12)	/* P2 4.1K Pull Up Enable  */
#define	P3PU		(*(__xdata volatile unsigned char *)0xfe13)	/* P3 4.1K Pull Up Enable  */
#define	P4PU		(*(__xdata volatile unsigned char *)0xfe14)	/* P4 4.1K Pull Up Enable  */
#define	P5PU		(*(__xdata volatile unsigned char *)0xfe15)	/* P5 4.1K Pull Up Enable  */
#define	P6PU		(*(__xdata volatile unsigned char *)0xfe16)	/* P6 4.1K Pull Up Enable  */
#define	P7PU		(*(__xdata volatile unsigned char *)0xfe17)	/* P7 4.1K Pull Up Enable  */

#define	P0NCS		(*(__xdata volatile unsigned char *)0xfe18)	/* P0 Non Schmit Trigger  0: 使能端口施密特触发功能(默认), 1: 禁止  */
#define	P1NCS		(*(__xdata volatile unsigned char *)0xfe19)	/* P1 Non Schmit Trigger  */
#define	P2NCS		(*(__xdata volatile unsigned char *)0xfe1a)	/* P2 Non Schmit Trigger  */
#define	P3NCS		(*(__xdata volatile unsigned char *)0xfe1b)	/* P3 Non Schmit Trigger  */
#define	P4NCS		(*(__xdata volatile unsigned char *)0xfe1c)	/* P4 Non Schmit Trigger  */
#define	P5NCS		(*(__xdata volatile unsigned char *)0xfe1d)	/* P5 Non Schmit Trigger  */
#define	P6NCS		(*(__xdata volatile unsigned char *)0xfe1e)	/* P6 Non Schmit Trigger  */
#define	P7NCS		(*(__xdata volatile unsigned char *)0xfe1f)	/* P7 Non Schmit Trigger  */

#define P0SR    (*(__xdata volatile unsigned char *)0xfe20) /* 端口电平转换速度  0: 快, 1: 慢(默认)  */
#define P1SR    (*(__xdata volatile unsigned char *)0xfe21)
#define P2SR    (*(__xdata volatile unsigned char *)0xfe22)
#define P3SR    (*(__xdata volatile unsigned char *)0xfe23)
#define P4SR    (*(__xdata volatile unsigned char *)0xfe24)
#define P5SR    (*(__xdata volatile unsigned char *)0xfe25)
#define P6SR    (*(__xdata volatile unsigned char *)0xfe26)
#define P7SR    (*(__xdata volatile unsigned char *)0xfe27)

#define P0DR    (*(__xdata volatile unsigned char *)0xfe28) /* 端口驱动电流控制  0: 增强驱动能力, 1: 一般驱动能力(默认)  */
#define P1DR    (*(__xdata volatile unsigned char *)0xfe29)
#define P2DR    (*(__xdata volatile unsigned char *)0xfe2a)
#define P3DR    (*(__xdata volatile unsigned char *)0xfe2b)
#define P4DR    (*(__xdata volatile unsigned char *)0xfe2c)
#define P5DR    (*(__xdata volatile unsigned char *)0xfe2d)
#define P6DR    (*(__xdata volatile unsigned char *)0xfe2e)
#define P7DR    (*(__xdata volatile unsigned char *)0xfe2f)

#define P0IE    (*(__xdata volatile unsigned char *)0xfe30)/* 端口数字信号输入使能  0: 禁止数字信号输入, 1: 使能数字信号输入(默认)  */
...
#define T3T4PIN   (*(__xdata volatile unsigned char *)0xfeac)
...
#define PWMB_ETRPS (*(__xdata volatile unsigned char *)0xfeb4)
#define PWMB_ENO   (*(__xdata volatile unsigned char *)0xfeb5)
#define PWMB_PS    (*(__xdata volatile unsigned char *)0xfeb6)
#define PWMB_IOAUX (*(__xdata volatile unsigned char *)0xfeb7)
...
#define PWMB_CR1   (*(__xdata volatile unsigned char *)0xfee0)
#define PWMB_CR2   (*(__xdata volatile unsigned char *)0xfee1)
#define PWMB_SMCR  (*(__xdata volatile unsigned char *)0xfee2)
#define PWMB_ETR   (*(__xdata volatile unsigned char *)0xfee3)
#define PWMB_IER   (*(__xdata volatile unsigned char *)0xfee4)
#define PWMB_SR1   (*(__xdata volatile unsigned char *)0xfee5)
#define PWMB_SR2   (*(__xdata volatile unsigned char *)0xfee6)
#define PWMB_EGR   (*(__xdata volatile unsigned char *)0xfee7)
#define PWMB_CCMR1 (*(__xdata volatile unsigned char *)0xfee8)
#define PWMB_CCMR2 (*(__xdata volatile unsigned char *)0xfee9)
#define PWMB_CCMR3 (*(__xdata volatile unsigned char *)0xfeea)
#define PWMB_CCMR4 (*(__xdata volatile unsigned char *)0xfeeb)
#define PWMB_CCER1 (*(__xdata volatile unsigned char *)0xfeec)
#define PWMB_CCER2 (*(__xdata volatile unsigned char *)0xfeed)
#define PWMB_CNTR  (*(__xdata volatile unsigned int *)0xfeee)
#define PWMB_CNTRH (*(__xdata volatile unsigned char *)0xfeee)
#define PWMB_CNTRL (*(__xdata volatile unsigned char *)0xfeef)
#define PWMB_PSCR  (*(__xdata volatile unsigned int *)0xfef0)
#define PWMB_PSCRH (*(__xdata volatile unsigned char *)0xfef0)
#define PWMB_PSCRL (*(__xdata volatile unsigned char *)0xfef1)
#define PWMB_ARR   (*(__xdata volatile unsigned int *)0xfef2)
#define PWMB_ARRH  (*(__xdata volatile unsigned char *)0xfef2)
#define PWMB_ARRL  (*(__xdata volatile unsigned char *)0xfef3)
#define PWMB_RCR   (*(__xdata volatile unsigned char *)0xfef4)
#define PWMB_CCR5  (*(__xdata volatile unsigned int *)0xfef5)
#define PWMB_CCR5H (*(__xdata volatile unsigned char *)0xfef5)
#define PWMB_CCR5L (*(__xdata volatile unsigned char *)0xfef6)
#define PWMB_CCR6  (*(__xdata volatile unsigned int *)0xfef7)
#define PWMB_CCR6H (*(__xdata volatile unsigned char *)0xfef7)
#define PWMB_CCR6L (*(__xdata volatile unsigned char *)0xfef8)
#define PWMB_CCR7  (*(__xdata volatile unsigned int *)0xfef9)
#define PWMB_CCR7H (*(__xdata volatile unsigned char *)0xfef9)
#define PWMB_CCR7L (*(__xdata volatile unsigned char *)0xfefa)
#define PWMB_CCR8  (*(__xdata volatile unsigned int *)0xfefb)
#define PWMB_CCR8H (*(__xdata volatile unsigned char *)0xfefb)
#define PWMB_CCR8L (*(__xdata volatile unsigned char *)0xfefc)
#define PWMB_BRK   (*(__xdata volatile unsigned char *)0xfefd)
#define PWMB_DTR   (*(__xdata volatile unsigned char *)0xfefe)
#define PWMB_OISR  (*(__xdata volatile unsigned char *)0xfeff)

/////////////////////////////////////////////////
//FD00H-FDFFH
/////////////////////////////////////////////////

#define     PWM0C       (*(__xdata volatile unsigned int *)0xff00)
#define     PWM0CH      (*(__xdata volatile unsigned char *)0xff00)
#define     PWM0CL      (*(__xdata volatile unsigned char *)0xff01)
#define     PWM0CKS     (*(__xdata volatile unsigned char *)0xff02)
#define     PWM0TADC    (*(__xdata volatile unsigned int *)0xff03)
#define     PWM0TADCH   (*(__xdata volatile unsigned char *)0xff03)
#define     PWM0TADCL   (*(__xdata volatile unsigned char *)0xff04)
#define     PWM0IF      (*(__xdata volatile unsigned char *)0xff05)
#define     PWM0FDCR    (*(__xdata volatile unsigned char *)0xff06)
#define     PWM00T1     (*(__xdata volatile unsigned int *)0xff10)
#define     PWM00T1H    (*(__xdata volatile unsigned char *)0xff10)
#define     PWM00T1L    (*(__xdata volatile unsigned char *)0xff11)
#define     PWM00T2     (*(__xdata volatile unsigned int *)0xff12)
#define     PWM00T2H    (*(__xdata volatile unsigned char *)0xff12)
#define     PWM00T2L    (*(__xdata volatile unsigned char *)0xff13)
#define     PWM00CR     (*(__xdata volatile unsigned char *)0xff14)
#define     PWM00HLD    (*(__xdata volatile unsigned char *)0xff15)
#define     PWM01T1     (*(__xdata volatile unsigned int *)0xff18)
#define     PWM01T1H    (*(__xdata volatile unsigned char *)0xff18)
#define     PWM01T1L    (*(__xdata volatile unsigned char *)0xff19)
#define     PWM01T2    	(*(__xdata volatile unsigned int *)0xff1a)
#define     PWM01T2H    (*(__xdata volatile unsigned char *)0xff1a)
#define     PWM01T2L    (*(__xdata volatile unsigned char *)0xff1b)
#define     PWM01CR     (*(__xdata volatile unsigned char *)0xff1c)
#define     PWM01HLD    (*(__xdata volatile unsigned char *)0xff1d)
#define     PWM02T1     (*(__xdata volatile unsigned int *)0xff20)
#define     PWM02T1H    (*(__xdata volatile unsigned char *)0xff20)
#define     PWM02T1L    (*(__xdata volatile unsigned char *)0xff21)
#define     PWM02T2    	(*(__xdata volatile unsigned int *)0xff22)
#define     PWM02T2H    (*(__xdata volatile unsigned char *)0xff22)
#define     PWM02T2L    (*(__xdata volatile unsigned char *)0xff23)
#define     PWM02CR     (*(__xdata volatile unsigned char *)0xff24)
#define     PWM02HLD    (*(__xdata volatile unsigned char *)0xff25)
#define     PWM03T1    	(*(__xdata volatile unsigned int *)0xff28)
#define     PWM03T1H    (*(__xdata volatile unsigned char *)0xff28)
#define     PWM03T1L    (*(__xdata volatile unsigned char *)0xff29)
#define     PWM03T2    	(*(__xdata volatile unsigned int *)0xff2a)
#define     PWM03T2H    (*(__xdata volatile unsigned char *)0xff2a)
#define     PWM03T2L    (*(__xdata volatile unsigned char *)0xff2b)
#define     PWM03CR     (*(__xdata volatile unsigned char *)0xff2c)
#define     PWM03HLD    (*(__xdata volatile unsigned char *)0xff2d)
#define     PWM04T1    	(*(__xdata volatile unsigned int *)0xff30)
#define     PWM04T1H    (*(__xdata volatile unsigned char *)0xff30)
#define     PWM04T1L    (*(__xdata volatile unsigned char *)0xff31)
#define     PWM04T2    	(*(__xdata volatile unsigned int *)0xff32)
#define     PWM04T2H    (*(__xdata volatile unsigned char *)0xff32)
#define     PWM04T2L    (*(__xdata volatile unsigned char *)0xff33)
#define     PWM04CR     (*(__xdata volatile unsigned char *)0xff34)
#define     PWM04HLD    (*(__xdata volatile unsigned char *)0xff35)
#define     PWM05T1     (*(__xdata volatile unsigned int *)0xff38)
#define     PWM05T1H    (*(__xdata volatile unsigned char *)0xff38)
#define     PWM05T1L    (*(__xdata volatile unsigned char *)0xff39)
#define     PWM05T2     (*(__xdata volatile unsigned int *)0xff3a)
#define     PWM05T2H    (*(__xdata volatile unsigned char *)0xff3a)
#define     PWM05T2L    (*(__xdata volatile unsigned char *)0xff3b)
#define     PWM05CR     (*(__xdata volatile unsigned char *)0xff3c)
#define     PWM05HLD    (*(__xdata volatile unsigned char *)0xff3d)
#define     PWM06T1     (*(__xdata volatile unsigned int *)0xff40)
#define     PWM06T1H    (*(__xdata volatile unsigned char *)0xff40)
#define     PWM06T1L    (*(__xdata volatile unsigned char *)0xff41)
#define     PWM06T2     (*(__xdata volatile unsigned int *)0xff42)
#define     PWM06T2H    (*(__xdata volatile unsigned char *)0xff42)
#define     PWM06T2L    (*(__xdata volatile unsigned char *)0xff43)
#define     PWM06CR     (*(__xdata volatile unsigned char *)0xff44)
#define     PWM06HLD    (*(__xdata volatile unsigned char *)0xff45)
#define     PWM07T1     (*(__xdata volatile unsigned int *)0xff48)
#define     PWM07T1H    (*(__xdata volatile unsigned char *)0xff48)
#define     PWM07T1L    (*(__xdata volatile unsigned char *)0xff49)
#define     PWM07T2     (*(__xdata volatile unsigned int *)0xff4a)
#define     PWM07T2H    (*(__xdata volatile unsigned char *)0xff4a)
#define     PWM07T2L    (*(__xdata volatile unsigned char *)0xff4b)
#define     PWM07CR     (*(__xdata volatile unsigned char *)0xff4c)
#define     PWM07HLD    (*(__xdata volatile unsigned char *)0xff4d)
#define     PWM1C       (*(__xdata volatile unsigned int *)0xff50)
#define     PWM1CH      (*(__xdata volatile unsigned char *)0xff50)
#define     PWM1CL      (*(__xdata volatile unsigned char *)0xff51)
#define     PWM1CKS     (*(__xdata volatile unsigned char *)0xff52)
#define     PWM1IF      (*(__xdata volatile unsigned char *)0xff55)
#define     PWM1FDCR    (*(__xdata volatile unsigned char *)0xff56)
#define     PWM10T1     (*(__xdata volatile unsigned int *)0xff60)
#define     PWM10T1H    (*(__xdata volatile unsigned char *)0xff60)
#define     PWM10T1L    (*(__xdata volatile unsigned char *)0xff61)
#define     PWM10T2     (*(__xdata volatile unsigned int *)0xff62)
#define     PWM10T2H    (*(__xdata volatile unsigned char *)0xff62)
#define     PWM10T2L    (*(__xdata volatile unsigned char *)0xff63)
#define     PWM10CR     (*(__xdata volatile unsigned char *)0xff64)
#define     PWM10HLD    (*(__xdata volatile unsigned char *)0xff65)
#define     PWM11T1     (*(__xdata volatile unsigned int *)0xff68)
#define     PWM11T1H    (*(__xdata volatile unsigned char *)0xff68)
#define     PWM11T1L    (*(__xdata volatile unsigned char *)0xff69)
#define     PWM11T2     (*(__xdata volatile unsigned int *)0xff6a)
#define     PWM11T2H    (*(__xdata volatile unsigned char *)0xff6a)
#define     PWM11T2L    (*(__xdata volatile unsigned char *)0xff6b)
#define     PWM11CR     (*(__xdata volatile unsigned char *)0xff6c)
#define     PWM11HLD    (*(__xdata volatile unsigned char *)0xff6d)
#define     PWM12T1     (*(__xdata volatile unsigned int *)0xff70)
#define     PWM12T1H    (*(__xdata volatile unsigned char *)0xff70)
#define     PWM12T1L    (*(__xdata volatile unsigned char *)0xff71)
#define     PWM12T2     (*(__xdata volatile unsigned int *)0xff72)
#define     PWM12T2H    (*(__xdata volatile unsigned char *)0xff72)
#define     PWM12T2L    (*(__xdata volatile unsigned char *)0xff73)
#define     PWM12CR     (*(__xdata volatile unsigned char *)0xff74)
#define     PWM12HLD    (*(__xdata volatile unsigned char *)0xff75)
#define     PWM13T1     (*(__xdata volatile unsigned int *)0xff78)
#define     PWM13T1H    (*(__xdata volatile unsigned char *)0xff78)
#define     PWM13T1L    (*(__xdata volatile unsigned char *)0xff79)
#define     PWM13T2     (*(__xdata volatile unsigned int *)0xff7a)
#define     PWM13T2H    (*(__xdata volatile unsigned char *)0xff7a)
#define     PWM13T2L    (*(__xdata volatile unsigned char *)0xff7b)
#define     PWM13CR     (*(__xdata volatile unsigned char *)0xff7c)
#define     PWM13HLD    (*(__xdata volatile unsigned char *)0xff7d)
#define     PWM14T1     (*(__xdata volatile unsigned int *)0xff80)
#define     PWM14T1H    (*(__xdata volatile unsigned char *)0xff80)
#define     PWM14T1L    (*(__xdata volatile unsigned char *)0xff81)
#define     PWM14T2     (*(__xdata volatile unsigned int *)0xff82)
#define     PWM14T2H    (*(__xdata volatile unsigned char *)0xff82)
#define     PWM14T2L    (*(__xdata volatile unsigned char *)0xff83)
#define     PWM14CR     (*(__xdata volatile unsigned char *)0xff84)
#define     PWM14HLD    (*(__xdata volatile unsigned char *)0xff85)
#define     PWM15T1     (*(__xdata volatile unsigned int *)0xff88)
#define     PWM15T1H    (*(__xdata volatile unsigned char *)0xff88)
#define     PWM15T1L    (*(__xdata volatile unsigned char *)0xff89)
#define     PWM15T2     (*(__xdata volatile unsigned int *)0xff8a)
#define     PWM15T2H    (*(__xdata volatile unsigned char *)0xff8a)
#define     PWM15T2L    (*(__xdata volatile unsigned char *)0xff8b)
#define     PWM15CR     (*(__xdata volatile unsigned char *)0xff8c)
#define     PWM15HLD    (*(__xdata volatile unsigned char *)0xff8d)
#define     PWM16T1     (*(__xdata volatile unsigned int *)0xff90)
#define     PWM16T1H    (*(__xdata volatile unsigned char *)0xff90)
#define     PWM16T1L    (*(__xdata volatile unsigned char *)0xff91)
#define     PWM16T2     (*(__xdata volatile unsigned int *)0xff92)
#define     PWM16T2H    (*(__xdata volatile unsigned char *)0xff92)
#define     PWM16T2L    (*(__xdata volatile unsigned char *)0xff93)
#define     PWM16CR     (*(__xdata volatile unsigned char *)0xff94)
#define     PWM16HLD    (*(__xdata volatile unsigned char *)0xff95)
#define     PWM17T1     (*(__xdata volatile unsigned int *)0xff98)
#define     PWM17T1H    (*(__xdata volatile unsigned char *)0xff98)
#define     PWM17T1L    (*(__xdata volatile unsigned char *)0xff99)
#define     PWM17T2     (*(__xdata volatile unsigned int *)0xff9a)
#define     PWM17T2H    (*(__xdata volatile unsigned char *)0xff9a)
#define     PWM17T2L    (*(__xdata volatile unsigned char *)0xff9b)
#define     PWM17CR     (*(__xdata volatile unsigned char *)0xff9c)
#define     PWM17HLD    (*(__xdata volatile unsigned char *)0xff9d)
#define     PWM2C       (*(__xdata volatile unsigned int *)0xffa0)
#define     PWM2CH      (*(__xdata volatile unsigned char *)0xffa0)
#define     PWM2CL      (*(__xdata volatile unsigned char *)0xffa1)
#define     PWM2CKS     (*(__xdata volatile unsigned char *)0xffa2)
#define     PWM2TADC    (*(__xdata volatile unsigned int *)0xffa3)
#define     PWM2TADCH   (*(__xdata volatile unsigned char *)0xffa3)
#define     PWM2TADCL   (*(__xdata volatile unsigned char *)0xffa4)
#define     PWM2IF      (*(__xdata volatile unsigned char *)0xffa5)
#define     PWM2FDCR    (*(__xdata volatile unsigned char *)0xffa6)
#define     PWM20T1     (*(__xdata volatile unsigned int *)0xffb0)
#define     PWM20T1H    (*(__xdata volatile unsigned char *)0xffb0)
#define     PWM20T1L    (*(__xdata volatile unsigned char *)0xffb1)
#define     PWM20T2     (*(__xdata volatile unsigned int *)0xffb2)
#define     PWM20T2H    (*(__xdata volatile unsigned char *)0xffb2)
#define     PWM20T2L    (*(__xdata volatile unsigned char *)0xffb3)
#define     PWM20CR     (*(__xdata volatile unsigned char *)0xffb4)
#define     PWM20HLD    (*(__xdata volatile unsigned char *)0xffb5)
#define     PWM21T1     (*(__xdata volatile unsigned int *)0xffb8)
#define     PWM21T1H    (*(__xdata volatile unsigned char *)0xffb8)
#define     PWM21T1L    (*(__xdata volatile unsigned char *)0xffb9)
#define     PWM21T2     (*(__xdata volatile unsigned int *)0xffba)
#define     PWM21T2H    (*(__xdata volatile unsigned char *)0xffba)
#define     PWM21T2L    (*(__xdata volatile unsigned char *)0xffbb)
#define     PWM21CR     (*(__xdata volatile unsigned char *)0xffbc)
#define     PWM21HLD    (*(__xdata volatile unsigned char *)0xffbd)
#define     PWM22T1     (*(__xdata volatile unsigned int *)0xffc0)
#define     PWM22T1H    (*(__xdata volatile unsigned char *)0xffc0)
#define     PWM22T1L    (*(__xdata volatile unsigned char *)0xffc1)
#define     PWM22T2     (*(__xdata volatile unsigned int *)0xffc2)
#define     PWM22T2H    (*(__xdata volatile unsigned char *)0xffc2)
#define     PWM22T2L    (*(__xdata volatile unsigned char *)0xffc3)
#define     PWM22CR     (*(__xdata volatile unsigned char *)0xffc4)
#define     PWM22HLD    (*(__xdata volatile unsigned char *)0xffc5)
#define     PWM23T1     (*(__xdata volatile unsigned int *)0xffc8)
#define     PWM23T1H    (*(__xdata volatile unsigned char *)0xffc8)
#define     PWM23T1L    (*(__xdata volatile unsigned char *)0xffc9)
#define     PWM23T2     (*(__xdata volatile unsigned int *)0xffca)
#define     PWM23T2H    (*(__xdata volatile unsigned char *)0xffca)
#define     PWM23T2L    (*(__xdata volatile unsigned char *)0xffcb)
#define     PWM23CR     (*(__xdata volatile unsigned char *)0xffcc)
#define     PWM23HLD    (*(__xdata volatile unsigned char *)0xffcd)
#define     PWM24T1     (*(__xdata volatile unsigned int *)0xffd0)
#define     PWM24T1H    (*(__xdata volatile unsigned char *)0xffd0)
#define     PWM24T1L    (*(__xdata volatile unsigned char *)0xffd1)
#define     PWM24T2     (*(__xdata volatile unsigned int *)0xffd2)
#define     PWM24T2H    (*(__xdata volatile unsigned char *)0xffd2)
#define     PWM24T2L    (*(__xdata volatile unsigned char *)0xffd3)
#define     PWM24CR     (*(__xdata volatile unsigned char *)0xffd4)
#define     PWM24HLD    (*(__xdata volatile unsigned char *)0xffd5)
#define     PWM25T1     (*(__xdata volatile unsigned int *)0xffd8)
#define     PWM25T1H    (*(__xdata volatile unsigned char *)0xffd8)
#define     PWM25T1L    (*(__xdata volatile unsigned char *)0xffd9)
#define     PWM25T2     (*(__xdata volatile unsigned int *)0xffda)
#define     PWM25T2H    (*(__xdata volatile unsigned char *)0xffda)
#define     PWM25T2L    (*(__xdata volatile unsigned char *)0xffdb)
#define     PWM25CR     (*(__xdata volatile unsigned char *)0xffdc)
#define     PWM25HLD    (*(__xdata volatile unsigned char *)0xffdd)
#define     PWM26T1     (*(__xdata volatile unsigned int *)0xffe0)
#define     PWM26T1H    (*(__xdata volatile unsigned char *)0xffe0)
#define     PWM26T1L    (*(__xdata volatile unsigned char *)0xffe1)
#define     PWM26T2     (*(__xdata volatile unsigned int *)0xffe2)
#define     PWM26T2H    (*(__xdata volatile unsigned char *)0xffe2)
#define     PWM26T2L    (*(__xdata volatile unsigned char *)0xffe3)
#define     PWM26CR     (*(__xdata volatile unsigned char *)0xffe4)
#define     PWM26HLD    (*(__xdata volatile unsigned char *)0xffe5)
#define     PWM27T1     (*(__xdata volatile unsigned int *)0xffe8)
#define     PWM27T1H    (*(__xdata volatile unsigned char *)0xffe8)
#define     PWM27T1L    (*(__xdata volatile unsigned char *)0xffe9)
#define     PWM27T2     (*(__xdata volatile unsigned int *)0xffea)
#define     PWM27T2H    (*(__xdata volatile unsigned char *)0xffea)
#define     PWM27T2L    (*(__xdata volatile unsigned char *)0xffeb)
#define     PWM27CR     (*(__xdata volatile unsigned char *)0xffec)
#define     PWM27HLD    (*(__xdata volatile unsigned char *)0xffed)

/////////////////////////////////////////////////
//FC00H-FCFFH
/////////////////////////////////////////////////

#define     PWM3C       (*(__xdata volatile unsigned int *)0xfc00)
#define     PWM3CH      (*(__xdata volatile unsigned char *)0xfc00)
#define     PWM3CL      (*(__xdata volatile unsigned char *)0xfc01)
#define     PWM3CKS     (*(__xdata volatile unsigned char *)0xfc02)
#define     PWM3IF      (*(__xdata volatile unsigned char *)0xfc05)
#define     PWM3FDCR    (*(__xdata volatile unsigned char *)0xfc06)
#define     PWM30T1     (*(__xdata volatile unsigned int *)0xfc10)
#define     PWM30T1H    (*(__xdata volatile unsigned char *)0xfc10)
#define     PWM30T1L    (*(__xdata volatile unsigned char *)0xfc11)
#define     PWM30T2     (*(__xdata volatile unsigned int *)0xfc12)
#define     PWM30T2H    (*(__xdata volatile unsigned char *)0xfc12)
#define     PWM30T2L    (*(__xdata volatile unsigned char *)0xfc13)
#define     PWM30CR     (*(__xdata volatile unsigned char *)0xfc14)
#define     PWM30HLD    (*(__xdata volatile unsigned char *)0xfc15)
#define     PWM31T1     (*(__xdata volatile unsigned int *)0xfc18)
#define     PWM31T1H    (*(__xdata volatile unsigned char *)0xfc18)
#define     PWM31T1L    (*(__xdata volatile unsigned char *)0xfc19)
#define     PWM31T2     (*(__xdata volatile unsigned int *)0xfc1a)
#define     PWM31T2H    (*(__xdata volatile unsigned char *)0xfc1a)
#define     PWM31T2L    (*(__xdata volatile unsigned char *)0xfc1b)
#define     PWM31CR     (*(__xdata volatile unsigned char *)0xfc1c)
#define     PWM31HLD    (*(__xdata volatile unsigned char *)0xfc1d)
#define     PWM32T1     (*(__xdata volatile unsigned int *)0xfc20)
#define     PWM32T1H    (*(__xdata volatile unsigned char *)0xfc20)
#define     PWM32T1L    (*(__xdata volatile unsigned char *)0xfc21)
#define     PWM32T2     (*(__xdata volatile unsigned int *)0xfc22)
#define     PWM32T2H    (*(__xdata volatile unsigned char *)0xfc22)
#define     PWM32T2L    (*(__xdata volatile unsigned char *)0xfc23)
#define     PWM32CR     (*(__xdata volatile unsigned char *)0xfc24)
#define     PWM32HLD    (*(__xdata volatile unsigned char *)0xfc25)
#define     PWM33T1     (*(__xdata volatile unsigned int *)0xfc28)
#define     PWM33T1H    (*(__xdata volatile unsigned char *)0xfc28)
#define     PWM33T1L    (*(__xdata volatile unsigned char *)0xfc29)
#define     PWM33T2     (*(__xdata volatile unsigned int *)0xfc2a)
#define     PWM33T2H    (*(__xdata volatile unsigned char *)0xfc2a)
#define     PWM33T2L    (*(__xdata volatile unsigned char *)0xfc2b)
#define     PWM33CR     (*(__xdata volatile unsigned char *)0xfc2c)
#define     PWM33HLD    (*(__xdata volatile unsigned char *)0xfc2d)
#define     PWM34T1     (*(__xdata volatile unsigned int *)0xfc30)
#define     PWM34T1H    (*(__xdata volatile unsigned char *)0xfc30)
#define     PWM34T1L    (*(__xdata volatile unsigned char *)0xfc31)
#define     PWM34T2     (*(__xdata volatile unsigned int *)0xfc32)
#define     PWM34T2H    (*(__xdata volatile unsigned char *)0xfc32)
#define     PWM34T2L    (*(__xdata volatile unsigned char *)0xfc33)
#define     PWM34CR     (*(__xdata volatile unsigned char *)0xfc34)
#define     PWM34HLD    (*(__xdata volatile unsigned char *)0xfc35)
#define     PWM35T1     (*(__xdata volatile unsigned int *)0xfc38)
#define     PWM35T1H    (*(__xdata volatile unsigned char *)0xfc38)
#define     PWM35T1L    (*(__xdata volatile unsigned char *)0xfc39)
#define     PWM35T2     (*(__xdata volatile unsigned int *)0xfc3a)
#define     PWM35T2H    (*(__xdata volatile unsigned char *)0xfc3a)
#define     PWM35T2L    (*(__xdata volatile unsigned char *)0xfc3b)
#define     PWM35CR     (*(__xdata volatile unsigned char *)0xfc3c)
#define     PWM35HLD    (*(__xdata volatile unsigned char *)0xfc3d)
#define     PWM36T1     (*(__xdata volatile unsigned int *)0xfc40)
#define     PWM36T1H    (*(__xdata volatile unsigned char *)0xfc40)
#define     PWM36T1L    (*(__xdata volatile unsigned char *)0xfc41)
#define     PWM36T2     (*(__xdata volatile unsigned int *)0xfc42)
#define     PWM36T2H    (*(__xdata volatile unsigned char *)0xfc42)
#define     PWM36T2L    (*(__xdata volatile unsigned char *)0xfc43)
#define     PWM36CR     (*(__xdata volatile unsigned char *)0xfc44)
#define     PWM36HLD    (*(__xdata volatile unsigned char *)0xfc45)
#define     PWM37T1     (*(__xdata volatile unsigned int *)0xfc48)
#define     PWM37T1H    (*(__xdata volatile unsigned char *)0xfc48)
#define     PWM37T1L    (*(__xdata volatile unsigned char *)0xfc49)
#define     PWM37T2     (*(__xdata volatile unsigned int *)0xfc4a)
#define     PWM37T2H    (*(__xdata volatile unsigned char *)0xfc4a)
#define     PWM37T2L    (*(__xdata volatile unsigned char *)0xfc4b)
#define     PWM37CR     (*(__xdata volatile unsigned char *)0xfc4c)
#define     PWM37HLD    (*(__xdata volatile unsigned char *)0xfc4d)
#define     PWM4C       (*(__xdata volatile unsigned int *)0xfc50)
#define     PWM4CH      (*(__xdata volatile unsigned char *)0xfc50)
#define     PWM4CL      (*(__xdata volatile unsigned char *)0xfc51)
#define     PWM4CKS     (*(__xdata volatile unsigned char *)0xfc52)
#define     PWM4TADC    (*(__xdata volatile unsigned int *)0xfc53)
#define     PWM4TADCH   (*(__xdata volatile unsigned char *)0xfc53)
#define     PWM4TADCL   (*(__xdata volatile unsigned char *)0xfc54)
#define     PWM4IF      (*(__xdata volatile unsigned char *)0xfc55)
#define     PWM4FDCR    (*(__xdata volatile unsigned char *)0xfc56)
#define     PWM40T1     (*(__xdata volatile unsigned int *)0xfc60)
#define     PWM40T1H    (*(__xdata volatile unsigned char *)0xfc60)
#define     PWM40T1L    (*(__xdata volatile unsigned char *)0xfc61)
#define     PWM40T2     (*(__xdata volatile unsigned int *)0xfc62)
#define     PWM40T2H    (*(__xdata volatile unsigned char *)0xfc62)
#define     PWM40T2L    (*(__xdata volatile unsigned char *)0xfc63)
#define     PWM40CR     (*(__xdata volatile unsigned char *)0xfc64)
#define     PWM40HLD    (*(__xdata volatile unsigned char *)0xfc65)
#define     PWM41T1     (*(__xdata volatile unsigned int *)0xfc68)
#define     PWM41T1H    (*(__xdata volatile unsigned char *)0xfc68)
#define     PWM41T1L    (*(__xdata volatile unsigned char *)0xfc69)
#define     PWM41T2     (*(__xdata volatile unsigned int *)0xfc6a)
#define     PWM41T2H    (*(__xdata volatile unsigned char *)0xfc6a)
#define     PWM41T2L    (*(__xdata volatile unsigned char *)0xfc6b)
#define     PWM41CR     (*(__xdata volatile unsigned char *)0xfc6c)
#define     PWM41HLD    (*(__xdata volatile unsigned char *)0xfc6d)
#define     PWM42T1     (*(__xdata volatile unsigned int *)0xfc70)
#define     PWM42T1H    (*(__xdata volatile unsigned char *)0xfc70)
#define     PWM42T1L    (*(__xdata volatile unsigned char *)0xfc71)
#define     PWM42T2     (*(__xdata volatile unsigned int *)0xfc72)
#define     PWM42T2H    (*(__xdata volatile unsigned char *)0xfc72)
#define     PWM42T2L    (*(__xdata volatile unsigned char *)0xfc73)
#define     PWM42CR     (*(__xdata volatile unsigned char *)0xfc74)
#define     PWM42HLD    (*(__xdata volatile unsigned char *)0xfc75)
#define     PWM43T1     (*(__xdata volatile unsigned int *)0xfc78)
#define     PWM43T1H    (*(__xdata volatile unsigned char *)0xfc78)
#define     PWM43T1L    (*(__xdata volatile unsigned char *)0xfc79)
#define     PWM43T2     (*(__xdata volatile unsigned int *)0xfc7a)
#define     PWM43T2H    (*(__xdata volatile unsigned char *)0xfc7a)
#define     PWM43T2L    (*(__xdata volatile unsigned char *)0xfc7b)
#define     PWM43CR     (*(__xdata volatile unsigned char *)0xfc7c)
#define     PWM43HLD    (*(__xdata volatile unsigned char *)0xfc7d)
#define     PWM44T1     (*(__xdata volatile unsigned int *)0xfc80)
#define     PWM44T1H    (*(__xdata volatile unsigned char *)0xfc80)
#define     PWM44T1L    (*(__xdata volatile unsigned char *)0xfc81)
#define     PWM44T2     (*(__xdata volatile unsigned int *)0xfc82)
#define     PWM44T2H    (*(__xdata volatile unsigned char *)0xfc82)
#define     PWM44T2L    (*(__xdata volatile unsigned char *)0xfc83)
#define     PWM44CR     (*(__xdata volatile unsigned char *)0xfc84)
#define     PWM44HLD    (*(__xdata volatile unsigned char *)0xfc85)
#define     PWM45T1     (*(__xdata volatile unsigned int *)0xfc88)
#define     PWM45T1H    (*(__xdata volatile unsigned char *)0xfc88)
#define     PWM45T1L    (*(__xdata volatile unsigned char *)0xfc89)
#define     PWM45T2     (*(__xdata volatile unsigned int *)0xfc8a)
#define     PWM45T2H    (*(__xdata volatile unsigned char *)0xfc8a)
#define     PWM45T2L    (*(__xdata volatile unsigned char *)0xfc8b)
#define     PWM45CR     (*(__xdata volatile unsigned char *)0xfc8c)
#define     PWM45HLD    (*(__xdata volatile unsigned char *)0xfc8d)
#define     PWM46T1     (*(__xdata volatile unsigned int *)0xfc90)
#define     PWM46T1H    (*(__xdata volatile unsigned char *)0xfc90)
#define     PWM46T1L    (*(__xdata volatile unsigned char *)0xfc91)
#define     PWM46T2     (*(__xdata volatile unsigned int *)0xfc92)
#define     PWM46T2H    (*(__xdata volatile unsigned char *)0xfc92)
#define     PWM46T2L    (*(__xdata volatile unsigned char *)0xfc93)
#define     PWM46CR     (*(__xdata volatile unsigned char *)0xfc94)
#define     PWM46HLD    (*(__xdata volatile unsigned char *)0xfc95)
#define     PWM47T1     (*(__xdata volatile unsigned int *)0xfc98)
#define     PWM47T1H    (*(__xdata volatile unsigned char *)0xfc98)
#define     PWM47T1L    (*(__xdata volatile unsigned char *)0xfc99)
#define     PWM47T2     (*(__xdata volatile unsigned int *)0xfc9a)
#define     PWM47T2H    (*(__xdata volatile unsigned char *)0xfc9a)
#define     PWM47T2L    (*(__xdata volatile unsigned char *)0xfc9b)
#define     PWM47CR     (*(__xdata volatile unsigned char *)0xfc9c)
#define     PWM47HLD    (*(__xdata volatile unsigned char *)0xfc9d)
#define     PWM5C       (*(__xdata volatile unsigned int *)0xfca0)
#define     PWM5CH      (*(__xdata volatile unsigned char *)0xfca0)
#define     PWM5CL      (*(__xdata volatile unsigned char *)0xfca1)
#define     PWM5CKS     (*(__xdata volatile unsigned char *)0xfca2)
#define     PWM5IF      (*(__xdata volatile unsigned char *)0xfca5)
#define     PWM5FDCR    (*(__xdata volatile unsigned char *)0xfca6)
#define     PWM50T1     (*(__xdata volatile unsigned int *)0xfcb0)
#define     PWM50T1H    (*(__xdata volatile unsigned char *)0xfcb0)
#define     PWM50T1L    (*(__xdata volatile unsigned char *)0xfcb1)
#define     PWM50T2     (*(__xdata volatile unsigned int *)0xfcb2)
#define     PWM50T2H    (*(__xdata volatile unsigned char *)0xfcb2)
#define     PWM50T2L    (*(__xdata volatile unsigned char *)0xfcb3)
#define     PWM50CR     (*(__xdata volatile unsigned char *)0xfcb4)
#define     PWM50HLD    (*(__xdata volatile unsigned char *)0xfcb5)
#define     PWM51T1     (*(__xdata volatile unsigned int *)0xfcb8)
#define     PWM51T1H    (*(__xdata volatile unsigned char *)0xfcb8)
#define     PWM51T1L    (*(__xdata volatile unsigned char *)0xfcb9)
#define     PWM51T2     (*(__xdata volatile unsigned int *)0xfcba)
#define     PWM51T2H    (*(__xdata volatile unsigned char *)0xfcba)
#define     PWM51T2L    (*(__xdata volatile unsigned char *)0xfcbb)
#define     PWM51CR     (*(__xdata volatile unsigned char *)0xfcbc)
#define     PWM51HLD    (*(__xdata volatile unsigned char *)0xfcbd)
#define     PWM52T1     (*(__xdata volatile unsigned int *)0xfcc0)
#define     PWM52T1H    (*(__xdata volatile unsigned char *)0xfcc0)
#define     PWM52T1L    (*(__xdata volatile unsigned char *)0xfcc1)
#define     PWM52T2     (*(__xdata volatile unsigned int *)0xfcc2)
#define     PWM52T2H    (*(__xdata volatile unsigned char *)0xfcc2)
#define     PWM52T2L    (*(__xdata volatile unsigned char *)0xfcc3)
#define     PWM52CR     (*(__xdata volatile unsigned char *)0xfcc4)
#define     PWM52HLD    (*(__xdata volatile unsigned char *)0xfcc5)
#define     PWM53T1     (*(__xdata volatile unsigned int *)0xfcc8)
#define     PWM53T1H    (*(__xdata volatile unsigned char *)0xfcc8)
#define     PWM53T1L    (*(__xdata volatile unsigned char *)0xfcc9)
#define     PWM53T2     (*(__xdata volatile unsigned int *)0xfcca)
#define     PWM53T2H    (*(__xdata volatile unsigned char *)0xfcca)
#define     PWM53T2L    (*(__xdata volatile unsigned char *)0xfccb)
#define     PWM53CR     (*(__xdata volatile unsigned char *)0xfccc)
#define     PWM53HLD    (*(__xdata volatile unsigned char *)0xfccd)
#define     PWM54T1     (*(__xdata volatile unsigned int *)0xfcd0)
#define     PWM54T1H    (*(__xdata volatile unsigned char *)0xfcd0)
#define     PWM54T1L    (*(__xdata volatile unsigned char *)0xfcd1)
#define     PWM54T2     (*(__xdata volatile unsigned int *)0xfcd2)
#define     PWM54T2H    (*(__xdata volatile unsigned char *)0xfcd2)
#define     PWM54T2L    (*(__xdata volatile unsigned char *)0xfcd3)
#define     PWM54CR     (*(__xdata volatile unsigned char *)0xfcd4)
#define     PWM54HLD    (*(__xdata volatile unsigned char *)0xfcd5)
#define     PWM55T1     (*(__xdata volatile unsigned int *)0xfcd8)
#define     PWM55T1H    (*(__xdata volatile unsigned char *)0xfcd8)
#define     PWM55T1L    (*(__xdata volatile unsigned char *)0xfcd9)
#define     PWM55T2     (*(__xdata volatile unsigned int *)0xfcda)
#define     PWM55T2H    (*(__xdata volatile unsigned char *)0xfcda)
#define     PWM55T2L    (*(__xdata volatile unsigned char *)0xfcdb)
#define     PWM55CR     (*(__xdata volatile unsigned char *)0xfcdc)
#define     PWM55HLD    (*(__xdata volatile unsigned char *)0xfcdd)
#define     PWM56T1     (*(__xdata volatile unsigned int *)0xfce0)
#define     PWM56T1H    (*(__xdata volatile unsigned char *)0xfce0)
#define     PWM56T1L    (*(__xdata volatile unsigned char *)0xfce1)
#define     PWM56T2     (*(__xdata volatile unsigned int *)0xfce2)
#define     PWM56T2H    (*(__xdata volatile unsigned char *)0xfce2)
#define     PWM56T2L    (*(__xdata volatile unsigned char *)0xfce3)
#define     PWM56CR     (*(__xdata volatile unsigned char *)0xfce4)
#define     PWM56HLD    (*(__xdata volatile unsigned char *)0xfce5)
#define     PWM57T1     (*(__xdata volatile unsigned int *)0xfce8)
#define     PWM57T1H    (*(__xdata volatile unsigned char *)0xfce8)
#define     PWM57T1L    (*(__xdata volatile unsigned char *)0xfce9)
#define     PWM57T2     (*(__xdata volatile unsigned int *)0xfcea)
#define     PWM57T2H    (*(__xdata volatile unsigned char *)0xfcea)
#define     PWM57T2L    (*(__xdata volatile unsigned char *)0xfceb)
#define     PWM57CR     (*(__xdata volatile unsigned char *)0xfcec)
#define     PWM57HLD    (*(__xdata volatile unsigned char *)0xfced)
...
//sfr ADC_RESH  = 0xBD;		ADCV.9 ADCV.8 ADCV.7 ADCV.6 ADCV.5 ADCV.4 ADCV.3 ADCV.2	  0000,0000	/* A/D 转换结果高8位 */ 
